HOW TO BUILD KERNEL 3.4.39 FOR SM-T320
...
1. How to Build
	...
	- make
			$ export ARCH=arm
			$ make VARIANT_DEFCONFIG=msm8974_sec_mondrianwifi_eur_defconfig msm8974_sec_defconfig SELINUX_DEFCONFIG=selinux_defconfig
			$ make
